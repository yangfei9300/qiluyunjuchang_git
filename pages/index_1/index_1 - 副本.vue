<template>
	<view>
		...
		<view class="topview colonn">
			...
			<view class="swperig m-left-30" style="width: 690rpx;"
			:style="{
				top:(menuButton.top+menuButton.height+15)+'px',
				}"
			>
				...
				>
					...
					>
						...
						style="width: 690rpx;" lazy-load
						 class="swperig1" :src="item.url+'?image/auto-orient,1/resize,p_27/quality,q_25'"></image>
					</swiper-item>
				</swiper>
				<view class="roww center_center pore" style="top: -30rpx;" >
					<block v-for="(item,index) in imgList">
				...
				<swiper-item  class="h-121 w-700" v-for="(item,index) in typeList">
					<view class="roww">
						<block v-for="(item1,index1) in item" >
							...
							>
								<image lazy-load :src="item1.gc_image+'?image/auto-orient,1/resize,p_27/quality,q_25'" class="typeicon" ></image>
		...
		<view class="banner2">
			<swiper class="banner2_1" autoplay>
				<swiper-item class="banner2_1" v-for="(item,index) in bannerList.floor_ads"
					@click.stop="selectedBanner(item)"
				>
					<image lazy-load :src="item.adv_code+'?image/auto-orient,1/resize,p_39/quality,q_42'" class="banner2_1"></image>
				</swiper-item>
			</swiper>
		</view>
		...
		>
			<view class="roww">
				...
				>
					...
					<view class="pore">
						<image lazy-load class="juimg" mode="aspectFill"  :src="item.goods_img_480+'?image/auto-orient,1/resize,p_39/quality,q_42'"></image>
		...
		>
			<view class="roww">
				...
				>	
					<view class="pore">
						<image lazy-load class="juimg" mode="aspectFill" :src="item.adv_code+'?image/auto-orient,1/resize,p_39/quality,q_42'"></image>
						<image src="/static/p10.png" class="w-60 h-30 poab"
						style="top:15rpx;left:15rpx;" v-if="item.goods_price>0"
						></image>
					</view>
		...
		>
			<view class="colonn" >
				...
				>
					...
					:src="item.article_pic+'?image/auto-orient,1/resize,p_39/quality,q_42'"></image>
